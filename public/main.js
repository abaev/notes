...
/* harmony import */ var _note_note_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./note/note.component */ "./src/app/note/note.component.ts");
/* harmony import */ var _contenteditable_model_directive__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./contenteditable-model.directive */ "./src/app/contenteditable-model.directive.ts");
...
/* harmony import */ var _delete_account_modal_delete_account_modal_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./delete-account-modal/delete-account-modal.component */ "./src/app/delete-account-modal/delete-account-modal.component.ts");
/* harmony import */ var _delete_acc_confirm_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./delete-acc-confirm.service */ "./src/app/delete-acc-confirm.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _note_note_component__WEBPACK_IMPORTED_MODULE_13__["NoteComponent"],
                _contenteditable_model_directive__WEBPACK_IMPORTED_MODULE_14__["ContenteditableModelDirective"],
                _footer_footer_component__WEBPACK_IMPORTED_MODULE_15__["FooterComponent"],
                _delete_account_modal_delete_account_modal_component__WEBPACK_IMPORTED_MODULE_16__["DeleteAccountModalComponent"]
            ],
            imports: [
            ...
            providers: [
                ...
                _delete_acc_confirm_service__WEBPACK_IMPORTED_MODULE_17__["DeleteAccConfirmService"]
            ],
            bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"]],
            entryComponents: [_delete_account_modal_delete_account_modal_component__WEBPACK_IMPORTED_MODULE_16__["DeleteAccountModalComponent"]]
        })
    ], AppModule);
    return AppModule;
}());
...
/* harmony import */ var _delete_account_modal_delete_account_modal_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../delete-account-modal/delete-account-modal.component */ "./src/app/delete-account-modal/delete-account-modal.component.ts");
/* harmony import */ var _delete_acc_confirm_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../delete-acc-confirm.service */ "./src/app/delete-acc-confirm.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NotesComponent = /** @class */ (function () {
    function NotesComponent(userService, conf, router, modalService, deleteAccConfirmService) {
        var _this = this;
        this.userService = userService;
        this.conf = conf;
        this.router = router;
    ...
    NotesComponent.prototype.getNotes = function (isInint) {
        ...
        this.userService.getNotes().subscribe(function (res) {
            ...
            Object.keys((new _user__WEBPACK_IMPORTED_MODULE_3__["User"]()).notes).forEach(function (k) {
                if (!res.notes[k])
                    res.notes[k] = [];
                for (var i = 0; i < 3; i++) {
                    if (!res.notes[k][i])
    ...
    NotesComponent.prototype.openModal = function () {
        var modalRef = this.modalService
            .open(_delete_account_modal_delete_account_modal_component__WEBPACK_IMPORTED_MODULE_6__["DeleteAccountModalComponent"], { centered: true });
    };
    ...
    NotesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"],
            _config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"],
            _delete_acc_confirm_service__WEBPACK_IMPORTED_MODULE_7__["DeleteAccConfirmService"]])
    ], NotesComponent);
